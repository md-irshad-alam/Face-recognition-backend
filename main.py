...
async def create_student(
    ...
    try:
        ...
        cursor = conn.cursor()
        query = """
        INSERT INTO students (id, name, program, section, email, phone, admission_date, photo_url)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
        """
        values = (id, name, program, section, email, phone, admission_date, photo_url)
                    ...
                    if len(face_distances) > 0:
                        ...
                        if matches[best_match_index]:
                            ...
                            if student:
                                ...
                                if database.check_attendance_status(student_id):
